...
const BrowseTaskDetails = () => {
    ...
    const { title, category, date, budget, cover, name, description } = useLoaderData();
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="text-center mb-8">
                ...
                <p>
                    A closer look into <span className="font-semibold text-[#0D9488]">{name}</span>'s task offer.
                </p>
            </div>
                ...
                <div className="flex flex-col justify-between space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-300">
                        <div className="p-4 border rounded-xl bg-gray-50 dark:bg-gray-800">
                            <p className="text-xs uppercase text-gray-500 dark:text-gray-400">Deadline</p>
                            <p className="font-semibold">{date}</p>
                        </div>
                        <div className="p-4 border rounded-xl bg-gray-50 dark:bg-gray-800">
                            <p className="text-xs uppercase text-gray-500 dark:text-gray-400">Budget</p>
